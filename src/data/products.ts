...
export const products: Product[] = [
  ...
  // Starter Kits
  {
    ...
    features: ["Entry-level racket", "3 premium balls", "Carry bag included", "Beginner's guide"],
    specs: {},
    isStarterKit: true,
  },
  {
    ...
    features: ["Mid-level racket", "6 competition balls", "Premium bag", "Overgrip set"],
    specs: {},
    isStarterKit: true,
  },
  {
    ...
    features: ["2 matching rackets", "6 premium balls", "Double racket bag", "Accessories included"],
    specs: {},
    isStarterKit: true,
  },
  {
    ...
    features: ["Competition racket", "12 tournament balls", "Pro tour bag", "Premium accessories"],
    specs: {},
    isStarterKit: true,
  },
  {
    ...
    features: ["4 rackets (mixed sizes)", "12 balls", "Large family bag", "Training materials"],
    specs: {},
    isStarterKit: true,
  },
  // Ball Types
